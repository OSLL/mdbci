task :run_unit do
  ...
  task :task_6863_tests_for_6821_show_box_config_node do |t| RakeTaskManager.new(t).run_unit end
  ...
  Rake::Task[:task_6863_tests_for_6821_show_box_config_node].execute
